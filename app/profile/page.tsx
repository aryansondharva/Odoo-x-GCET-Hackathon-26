            ...
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <Badge className="mt-2 bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300 hover:bg-blue-100">
                    {user.department}
                  </Badge>
                </div>
              </div>
              ...
              <CardContent>
                <div className="space-y-4">
                  {section.items.map((item, itemIdx) => (
                    <div key={itemIdx} className="flex items-start gap-3 pb-3 border-b border-border last:border-0">
                      {item.icon && <item.icon className="w-5 h-5 text-muted-foreground mt-0.5 flex-shrink-0" />}
            ...
            <div className="space-y-3">
              {[
                ...
                >
                  ...
                  <Button variant="ghost" size="sm" onClick={() => handleDownload(doc.name)} className="gap-1">
